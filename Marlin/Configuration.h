...
#define STRING_CONFIG_H_AUTHOR "ender@arnolds.us" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro 4.2.7, CRTouch, Filament Sensor"
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 15 }
